...
def grundfos_forecasting(prepared_data, product_group_exp_smoothing_model):
    simple_exp_model = Holts(TRAINING_SIZE, FORECAST_SIZE, 0.2, 0, 0, is_damped=False, do_print=DO_PRINT)
...
def main():
    ...
    # forecast with the Grundfos approach
        ...
        predictions = [grundfos_forecasting(data, holts_model),
                       grundfos_forecasting(data, arima_model),
